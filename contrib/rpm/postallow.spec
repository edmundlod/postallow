%{!?pkg_version: %global pkg_version 4.6.0}
...
%changelog
* Wed Sep 16 2026 Edmund Lodewijks <edmund@proteamail.com> - 4.6.0-1
- Port spf-tools' despf.sh/normalize.sh directly into postallow (no longer external deps)
- Vendor route-summarization's aggregateCIDR.pl into contrib/ (no longer an external dep)
- Fix aggregateCIDR.pl shebang for portability (#!/usr/bin/env perl)
- Replace spf-tools/route-summarization Requires with perl + perl-Net-CIDR-Lite
